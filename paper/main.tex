...
Paillier compact sum & 8 clients, 24-D updates, 2048-bit key & $64\times$ bytes, $2.64\times10^{-7}$ max error & Real additive sum; 14.69 s encryption and 1.44 s aggregate/decrypt in this local microbenchmark. \\
